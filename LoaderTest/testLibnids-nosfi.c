...
int main() {
    ...
    nids_params.filename = "/home/toney/Pcap/traffic";
    ...
    unsigned long nsec_val = (unsigned long)sec_val * 1000000000UL;
    unsigned long real_time = nsec_val + te.tv_nsec - ts.tv_nsec;
    printf("Time elapsed: %lf seconds\n", (double)real_time / (double)1000000000);
    return 0;
}
